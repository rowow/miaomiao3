<template>
   <div id="detailContainer" class="slider-entry-active">
        <Header title="影片详情">
            <!-- 组件Header新增i标签，故所以需要在该组件添加标签slot -->
            <i class="iconfont icon-right" @click="hanleToBack"></i>
        </Header>
...
<style scoped>
#detailContainer{width: 100%;min-height: 100%; position: absolute;left: 0;top: 0;z-index: 100;background: white;}
#detailContainer.slider-entry-active{animation: .3s slideMove }
@keyframes slideMove{
